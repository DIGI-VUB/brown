...
typedef pair<double, int> DoubleInt;
...
typedef unordered_map<IntVec, double, vector_hf, vector_eq> IntVecDoubleMap;
...
typedef unordered_map<IntPair, double, pair_hf, pair_eq> IntPairDoubleMap;
